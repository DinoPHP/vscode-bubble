        ...
        if (config.hover === true) {
            context.subscriptions.push(vscode__default['default'].languages.registerHoverProvider(type, {
                provideHover(document, position) {
                    ...
                    for (const snippet in bubbleArr) {
                        if (bubbleArr[snippet].prefix == word || bubbleArr[snippet].hover == word) {
                            return createHover(bubbleArr[snippet], type)
                        }
                    }
                }
            }));
